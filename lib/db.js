...
const driverPrototype = require('./driver/driver-prototype');
...
exports.runMigrations = async function(migrationsDir) {
	if (!_connectionManager){
		throw new Error('DB not initialized!');
  }

  await Migrations(_connectionManager, {logger:_logger, migrationsDir});
}
